<template>
  <div class="bg-black">
    ...
    <header class="relative">
      <div class="py-4 max-w-screen-xl mx-auto sticky top-0">
        <div class="">
          <nav class="flex items-center justify-between flex-wrap">
            ...
            >
              <div class="text-sm lg:flex-grow animated jackinthebox xl:mx-8">
                <a
                  href="#home"
                ...
                <a
                  href="#home"
                  class="block lg:inline-block text-md font-bold text-gray-300 sm:hover:border-indigo-400 hover:text-orange-500 mx-2 focus:text-blue-500 p-1 hover:bg-gray-300 sm:hover:bg-transparent rounded-lg"
                >
                  ROAD & STORY
                </a>
                <a
    ...
    <!-- Products -->
    <section class="bg-gray-900 py-8 antialiased dark:bg-gray-900 md:py-12">
      <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
              ...
              >
                ...
                <li aria-current="page">
                  <div class="flex items-center">
                    ...
                    <span
                      class="ms-1 text-sm font-medium text-slate-400 md:ms-2"
                      >Electronics</span
                    >
                  </div>
                </li>
        ...
        <div
          class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4 text-gray-400"
        >
          <div class="bg-slate-800 p-6">
            ...
            <div class="pt-6">
              <div class="mb-4 flex items-center justify-between gap-4">
                <span
                  class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium"
                >
                  Up to 35% off
                </span>
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-slate-400">(455)</p>
              </div>
              ...
              <ul class="mt-2 flex items-center gap-4">
                ...
                <li class="flex items-center gap-2">
                  ...
                  <p class="text-sm font-medium text-slate-400">Best Price</p>
                </li>
              </ul>
              ...
              <div class="mt-4 flex items-center justify-between gap-4">
                ...
                <button
                  type="button"
                  class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                >
                  <svg
          ...
          <div
            class="bg-slate-800 p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800"
          >
            <div class="h-56 w-full">
              <a href="#">
                <img
            ...
            <div class="pt-6">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-slate-400">(1,233)</p>
              </div>
              ...
              <ul class="mt-2 flex items-center gap-4">
                <li class="flex items-center gap-2">
                  ...
                  <p class="text-sm font-medium text-slate-400">Best Seller</p>
                </li>
          ...
          >
            ...
            <div class="pt-6">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-slate-400">(879)</p>
              </div>
          ...
          >
            ...
            <div class="pt-6">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-slate-400">(2,957)</p>
              </div>
          ...
          >
            ...
            <div class="pt-6">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-slate-400">(4,263)</p>
              </div>
          ...
          >
            ...
            <div class="pt-6">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-slate-400">(1,076)</p>
              </div>
          ...
          >
            ...
            <div class="pt-6">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-slate-400">(387)</p>
              </div>
          ...
          >
            ...
            <div class="pt-6">
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-slate-400">(4,775)</p>
              </div>
    ...
    <div class="py-16 bg-slate-800 overflow-hidden">
      <div
        class="max-w-screen-xl mx-auto px-6 space-y-8 text-gray-500 md:px-12"
      >
        <div
